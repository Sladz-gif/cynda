...
const PerformanceComingSoonPage = () => {
  ...
  const onSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Added to list",
        description: "We'll let you know as soon as Performance v1.2 is ready.",
      });
    } catch (err: any) {
      ...
      toast({
        ...
        description: "Your request has been noted for the Performance launch.",
      });
    } finally {
      setIsLoading(false);
    }
