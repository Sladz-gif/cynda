...
const ChatComingSoonPage = () => {
  ...
  // Dummy submissions for local state
  ...
  const onSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Added to list",
        description: "We'll let you know as soon as Chat v1.2 is ready.",
      });
    } catch (err: any) {
      ...
      toast({
        ...
        description: "Your request has been noted for the Chat v1.2 launch.",
      });
    } finally {
      setIsLoading(false);
    }
      ...
      <div className="rounded-3xl border-2 border-border bg-card p-8 space-y-6">
        <div className="flex items-start gap-5 flex-wrap">
          ...
          <div className="min-w-[240px]">
            <h1 className="font-display text-3xl font-black uppercase tracking-tight">Chat</h1>
