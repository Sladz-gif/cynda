...
const CheckoutPage = () => {
  ...
  const { adminProfile, countryCode } = useIndustryStore();
  const {
    convertFromUSD,
    calculateCredits,
    USD_TO_CREDIT_RATE,
                      ...
                      {seatCount > 0 && seatPriceUSD && (
                        <div className="flex justify-between items-baseline">
                          ...
                          <div className="text-right">
                            ...
                            {userCurrency !== 'USD' && (
                              <p className="text-xs text-muted-foreground">
                                ~{userCurrencySymbol}{seatTotalUser.toFixed(2)}
                              </p>
                            )}
                          </div>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-sm font-medium">
                            Prices shown in USD for Paystack processing
                          </span>
                        </div>
                      </div>
